# Run the test file via the terminal: python3 program_3_test.py program_3_{#}.py
import unittest
...
class BookTests(unittest.TestCase):
    def test_check_out(self):
        book = program_3.Book("Title", "Author")
        book.check_out()
...
class PatronTests(unittest.TestCase):
    def test_check_out_book(self):
        book = program_3.Book("Title", "Author")
        patron = program_3.Patron("Alice")
        patron.check_out_book(book)
        self.assertIn(book, patron.checked_out_books)

    def test_check_out_book_reached_limit(self):
        book1 = program_3.Book("Title 1", "Author")
        book2 = program_3.Book("Title 2", "Author")
        book3 = program_3.Book("Title 3", "Author")
        book4 = program_3.Book("Title 4", "Author")
        patron = program_3.Patron("Alice")
